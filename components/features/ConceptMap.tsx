...
// FIX: Use named imports from d3 to resolve module resolution issues.
import {
    select,
    forceSimulation,
    forceLink,
...
const D3Graph: React.FC<D3GraphProps> = ({ data, isFullscreen }) => {
    ...
    useEffect(() => {
        ...
        // FIX: Replaced d3.select with select from named import.
        ...
        // d3.forceLink mutates the links array, replacing string IDs with node object references
        // FIX: Replaced d3.force* functions with named imports.
        ...
        const node = g.append("g")
            ...
            .data(data.nodes)
            .join("g")
            // FIX: Renamed local drag function to createDragHandler to avoid conflict with d3.drag.
        ...
        // FIX: Replaced d3.scaleOrdinal and d3.schemeCategory10 with named imports.
        ...
        simulation.on("tick", () => {
            link
                // FIX: Replaced d3.SimulationNodeDatum type cast with named import.
        ...
        // FIX: Replaced d3.zoom with named import and renamed variable to avoid conflict.
        const zoomBehavior = zoom<SVGSVGElement, unknown>()
            .scaleExtent([0.1, 4])
            .on("zoom", (event) => g.attr("transform", event.transform));
        svg.call(zoomBehavior);

        // FIX: Replaced d3.Simulation with named import and renamed function to avoid conflict with d3.drag.
        function createDragHandler(simulation: Simulation<ConceptNode, undefined>) {
            ...
            // FIX: Replaced d3.drag with named import.
            return drag()
